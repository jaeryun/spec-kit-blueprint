...
>
> This conversation builds a **delivery roadmap** from your vision. We'll define Spec-outlines (think: Jira Epic-sized units of work) and their dependencies.
>
> **We cover:**
...
**Spec** — Write `—` until the spec file exists. Linked automatically by `roadmap-sync` after `/speckit.specify`.
