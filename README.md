...
A **Spec Outline** is a planning artifact in `roadmap.md` — it defines the goal, scope, and dependencies for one `/speckit.specify` run, sized to a single Jira Epic (2–4+ sprints).
